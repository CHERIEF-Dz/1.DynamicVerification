...
public class HMUAddAll extends ConcreteEvent {

    private boolean alreadyWarned;
    private String variableName;

    public HMUAddAll(CodeLocation location, String variableName) {
        super(location);
        this.alreadyWarned=false;
        this.variableName=variableName;
    }

    public void execute(MapStructure linkedStructure, int size) {
        this.isExecuted=true;
        //System.out.println("Test[Add] : " + this.location.toString());
        linkedStructure.setElements(size);
